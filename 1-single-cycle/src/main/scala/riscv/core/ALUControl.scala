    ...
    is(InstructionTypes.OpImm) {
      ...
      io.alu_funct := MuxLookup(io.funct3, ALUFunctions.zero)(
        Seq(
          ...
          InstructionsTypeI.sri   -> Mux(io.funct7(5).asBool, ALUFunctions.sra , ALUFunctions.srl)
        )
      )
    }
    ...
    is(InstructionTypes.Op) {
      ...
      io.alu_funct := MuxLookup(io.funct3, ALUFunctions.zero)(
        Seq(
          ...
          //   funct7[5] = 1 → SUB
          // TODO: Complete Mux selection logic
          InstructionsTypeR.add_sub ->  Mux(io.funct7=== 1.U , ALUFunctions.sub , ALUFunctions.add),
          ...
          // TODO: Complete Mux selection logic
          InstructionsTypeR.sr   -> Mux(io.funct7(5).asBool , ALUFunctions.sra , ALUFunctions.srl)
        )
      )
    }
